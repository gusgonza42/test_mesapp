package abp.project.v2Videojuegos.m03uf5ra2;
...
public class Main {
    ...
    public void buscarPjPorNombre(String nombre) {

        //TODO: imprime los datos por consola.
    }
    public void buscarPjPorAno(int ano) {

        //TODO: imprime los datos por consola.
    }
    public void buscarPjPorRango(int inicio, int fin) {

        //TODO: imprime los datos por consola.
    }
    public void buscarPjPorPrimeraLetra(char letra) {

        //TODO: imprime los datos por consola.
    }
    public void buscarPjPorTexto(String texto) {
